...
<body>
	<form name="frm" method="get" action="adshippedcompletelist"
		id="script_reset">
				...
				<div id="tabNumber" class="tabCont" style="display: block;">
					...
					<div class="mBoard typeOrder gScroll gCellSingle typeList"
						...
						<table id="searchResultList" border="1" summary=""
							...
							<c:forEach items="${map.scList}" var="scList">
								<c:choose>
									<c:when test="${scList != null}">
										<tbody>
											<tr>
												<td scope="col" style="width: 24px;"><input
													type="checkbox" id="allChk" /></td>
												<td scope="col" style="width: 150px;">${scList.odate}<br />${scList.ocode}</td>
												<td scope="col" style="width: 85px;">${scList.mid }
													<div class="cTip eSmartMode" code="OD.OF.DC.110" />
												</td>
												<td scope="col" style="width: 160px;">-</td>
												<td scope="col" style="width: 110px;">${scList.shipnum }
												</td>
												<td scope="col" style="width: 105px;">${scList.supplier }</td>
												<td scope="col" style="width: 240px;">${scList.prodname }</td>
												<td scope="col" class="w40" style="">${scList.oiamount }</td>
												<td scope="col" style="width: 100px;">${scList.oitotalprice}</td>
												<td scope="col" style="width: 45px;">${scList.memocontent }</td>
											</tr>
										</tbody>
									</c:when>
									<c:otherwise>
